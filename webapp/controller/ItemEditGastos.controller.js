sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.zapp006.controller.ItemEditGastos", {
		...
		_onButtonPress15: function() {
			...
			var oListBase = this.getView().byId(
				"sap_uxap_ObjectPageLayout_0-sections-sap_uxap_ObjectPageSection-1-a3a1b56f77a50cbb0e5f49f37_S7-947bf9d86208f9660e631ead16_S16-subSections-sap_uxap_ObjectPageSubSection-1503678298425-blocks-build_simple_Table-1503678339330"
			);
			...
			return new Promise(function(fnResolve, fnReject) {
				if (oListBase instanceof sap.m.ListBase && mUserSelectionModes[oListBase.getMode()]) {
					...
					var aItems = oListBase.getSelectedItems();
		...
		onInit: function() {
			...
			this.oRouter.getTarget("ItemEditGastos").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
