sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.zapp006.controller.ItemCrea", {
		...
		_onButtonPress12: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				.then(function(result) {
					return new Promise(function(fnResolve) {
						sap.m.MessageBox.confirm("Está seguro de descartar los cambios?", {
		...
		onInit: function() {
			...
			this.oRouter.getTarget("ItemCrea").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
